...
<div id="Language" class="tabcontent" style="height: auto;">
    ...
    <form action="" method="post">
        ...
        <option <?php if($_SESSION['language'] == "Chinese"){ echo "selected";} ?> >Chinese</option>
        <option <?php if($_SESSION['language'] == "Russian"){ echo "selected";} ?> >Russian</option>
        <option <?php if($_SESSION['language'] == "Spanish"){ echo "selected";} ?> >Spanish</option>
        <option <?php if($_SESSION['language'] == "ردو<"){ echo "selected";} ?> >اردو</option>
        </select>
        </p>
        <div style="background: #e9ebee; border-radius: 3px; padding: 15px;">
