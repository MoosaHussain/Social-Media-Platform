...
<head>
    <title><? echo lang('create_new_account'); ?> | Forbes</title>
    <meta charset="UTF-8">
    <meta name="description" content="Forbes is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
    <meta name="keywords" content="signup,social network,social media,Forbes,meet,free platform">
    ...
    <div class="login_signup_navbar">
        <a href="index" class="login_signup_navbarLinks">Forbes</a>
